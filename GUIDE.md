...
❗ Нельзя использовать в объекте переменных ключи с дефисом `test-1`,<br> если в компоненте вы их вызываете через `context.test-1`
...
## Для серьезных проектов имеет смысл немного изменить подход в создании и использовании переменных.
